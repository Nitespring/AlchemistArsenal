...
public class GameEvents {
    ...
    public static void registerBrewingRecipes(RegisterBrewingRecipesEvent event) {
        ...
        builder.addMix(
                ...
                MobEffectInit.ENGORGEMENT_POTION
        );
        builder.addMix(
                MobEffectInit.ENGORGEMENT_POTION,
                Items.REDSTONE,
                MobEffectInit.LONG_ENGORGEMENT_POTION
        );
        builder.addMix(
                MobEffectInit.ENGORGEMENT_POTION,
                Items.GLOWSTONE_DUST,
                MobEffectInit.ENGORGEMENT_II_POTION
        );
        builder.addMix(
                MobEffectInit.LONG_ENGORGEMENT_POTION,
                Items.GLOWSTONE_DUST,
                MobEffectInit.LONG_ENGORGEMENT_II_POTION
        );
        builder.addMix(
                MobEffectInit.ENGORGEMENT_II_POTION,
                Items.REDSTONE,
        ...
        builder.addMix(
                MobEffectInit.ENGORGEMENT_II_POTION,
                Items.GLOWSTONE,
                MobEffectInit.ENGORGEMENT_III_POTION
        );
        builder.addMix(
                MobEffectInit.LONG_ENGORGEMENT_II_POTION,
                Items.GLOWSTONE,
                MobEffectInit.LONG_ENGORGEMENT_III_POTION
        );
        builder.addMix(
                MobEffectInit.ENGORGEMENT_III_POTION,
                Items.REDSTONE,
        ...
        builder.addMix(
                ...
                MobEffectInit.SHRINKAGE_POTION
        );
        builder.addMix(
                MobEffectInit.SHRINKAGE_POTION,
                Items.REDSTONE,
                MobEffectInit.LONG_SHRINKAGE_POTION
        );
        builder.addMix(
                MobEffectInit.SHRINKAGE_POTION,
                Items.GLOWSTONE_DUST,
                MobEffectInit.SHRINKAGE_II_POTION
        );
        builder.addMix(
                MobEffectInit.LONG_SHRINKAGE_POTION,
                Items.GLOWSTONE_DUST,
                MobEffectInit.LONG_SHRINKAGE_II_POTION
        );
        builder.addMix(
                MobEffectInit.SHRINKAGE_II_POTION,
                Items.REDSTONE,
        ...
        builder.addMix(
                MobEffectInit.SHRINKAGE_II_POTION,
                Items.GLOWSTONE,
                MobEffectInit.SHRINKAGE_III_POTION
        );
        builder.addMix(
                MobEffectInit.LONG_SHRINKAGE_II_POTION,
                Items.GLOWSTONE,
                MobEffectInit.LONG_SHRINKAGE_III_POTION
        );
        builder.addMix(
                MobEffectInit.SHRINKAGE_III_POTION,
                Items.REDSTONE,
        ...
        builder.addMix(
                MobEffectInit.ENGORGEMENT_POTION,
                ItemInit.UNSTABLE_CONCOCTION.get(),
                MobEffectInit.TASTY_POTION
        );
        builder.addMix(
                MobEffectInit.TASTY_POTION,
                Items.FERMENTED_SPIDER_EYE,
                MobEffectInit.UNTASTY_POTION
        );
        builder.addMix(
                MobEffectInit.TASTY_POTION,
                Items.COCOA_BEANS,
